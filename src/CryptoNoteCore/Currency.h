...
public:
  ...
  size_t legacyDifficultyWindow() const { return m_legacyDifficultyWindow; }
  size_t legacyDifficultyLag() const { return m_legacyDifficultyLag; }
  size_t legacyDifficultyCut() const { return m_legacyDifficultyCut; }
  size_t legacyDifficultyBlocksCount() const { return m_legacyDifficultyWindow + m_legacyDifficultyLag; }
  ...
  Difficulty nextDifficulty(uint8_t version, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<Difficulty> cumulativeDifficulties, uint64_t nextBlockTimestamp) const;
...
private:
  ...
  size_t m_legacyDifficultyWindow;
  size_t m_legacyDifficultyLag;
  size_t m_legacyDifficultyCut;
...
public:
  ...
  CurrencyBuilder& legacyDifficultyWindow(size_t val);
  CurrencyBuilder& legacyDifficultyLag(size_t val) { m_currency.m_legacyDifficultyLag = val; return *this; }
  CurrencyBuilder& legacyDifficultyCut(size_t val) { m_currency.m_legacyDifficultyCut = val; return *this; }
